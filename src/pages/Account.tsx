        ...
        <div className="flex items-center gap-4">
          <div className="relative group cursor-pointer" onClick={() => fileInputRef.current?.click()}>
            <Avatar className="h-14 w-14 border-2 border-white/20">
              {profile?.avatar_url ? (
                <AvatarImage src={profile.avatar_url} alt={`Foto de perfil de ${profile?.display_name || user?.email || "usuário"}`} />
              ) : null}
      ...
      <div className="mb-6 rounded-2xl border border-white/10 bg-white/[0.03] p-6 animate-fade-in">
        ...
        {subscribed && tierInfo ? (
          <div className="space-y-3">
            ...
            <Button onClick={handleManageSubscription} disabled={portalLoading} variant="outline" className="w-full gap-2 bg-white text-gray-900 hover:bg-gray-100 hover:text-gray-900 border-gray-200">
